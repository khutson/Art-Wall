# -*- coding: utf-8 -*-
#
# artwall documentation build configuration file, created by
...
file_text = read(fpath('../artwall/__meta__.py'))
...
latex_documents = [
    ('index', 'artwall.tex', u'artwall Documentation',
        u'Kent Hutson', 'manual'),
]
...
man_pages = [
    ('index', 'artwall', u'artwall Documentation',
        [u'Kent Hutson'], 1)
]
...
texinfo_documents = [
    ('index', 'artwall', u'artwall Documentation',
        u'Kent Hutson', 'artwall', 'One line description of project.',
        'Miscellaneous'),
]
